# Hi there! 👋 I'm Shreyash Sridhar Iyengar

## About Me
- 🎓 Master's student in Computer Science at Purdue University
- 🎓 Bachelor's in Electrical Engineering and Computer Science, Minor in Data Science from UC Berkeley
- 🤖 Passionate about AI, ML, and robotics — with a focus on LLMs, RAG pipelines, and autonomous systems  
- 💼 Former Machine Learning Intern @ AWS AI (AutoGluon team) — Summer 2024, Summer 2023  
- 🧑‍🔬 Former intern @ Amazon (Telemetry team), Hewlett Packard Enterprise (Greenlake HPC) - Summer 2022, 2021
...
- 🎥 Bandwidth optimization for multi-stream computer vision in edge computing environments using mixed-integer linear programming
